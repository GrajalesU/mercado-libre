...
const BenefitCard = ({
  ...
  <article className='relative aspect-video h-[184px] overflow-hidden rounded-md lg:h-[250px] lg:w-[384px]'>
    <Image
      src={bgSrc}
      alt={bgAlt}
      width={384}
    ...
    <div
      ...
      className='absolute bottom-0 left-0 right-0 z-10 flex flex-col items-center gap-0 lg:mt-8 lg:flex-row lg:gap-4 lg:pb-4 lg:pl-4 '
    >
      <Image
        src={logoSrc}
        width={80}
